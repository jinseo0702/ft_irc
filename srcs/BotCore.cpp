...
void Bot::setupCommands() {
    // 명령어 등록
    BotCommand helpCmd = {BOT_HELP, "help", "도움말을 보여줍니다", {"h", "?"}};
    BotCommand timeCmd = {BOT_TIME, "time", "현재 시간을 보여줍니다", {"clock"}};
    BotCommand weatherCmd = {BOT_WEATHER, "weather", "날씨 정보를 보여줍니다", {"w"}};
    BotCommand calcCmd = {BOT_CALC, "calc", "수식을 계산합니다", {"calculate", "c"}};
    BotCommand quoteCmd = {BOT_QUOTE, "quote", "랜덤 명언을 보여줍니다", {"q"}};
    BotCommand rollCmd = {BOT_ROLL, "roll", "주사위를 굴립니다", {"dice"}};
    BotCommand eightBallCmd = {BOT_8BALL, "8ball", "8번 공에게 질문합니다", {"8"}};

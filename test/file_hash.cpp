...
void test_known_vectors() {
    ...
    std::string result = SHA256::SHA256Maker("");
    ...
    result = SHA256::SHA256Maker("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq");
...
int main(int argc, char* argv[]) {
    ...
    if (argc == 2) {
        ...
        result = SHA256::SHA256Maker(input);
        // Check if it's a file or string
    }
    
    std::cout << "Usage:" << std::endl;
    std::cout << "  " << result << "                    # Run test vectors" << std::endl;
